                    ...
                    <div class="d-flex justify-content-between">
                        <div class="col-sm-6 col-md-4 col-xl-3">
                            <a class="modal-effect btn btn-outline-primary btn-block" data-effect="effect-scale"
                                data-toggle="modal" href="#exampleModal">  ضافة المنتج </a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                                ...
                                                <button class="btn btn-outline-success btn-sm"
                                                    ...
                                                    data-category_name="{{ $x->category->category_name }}"
                                                    data-description="{{ $x->description }}" data-toggle="modal"
                                                    data-target="#exampleModal2"> <i class="las la-pen"></i>  تعديل </button>

                                                <button class="btn btn-outline-danger btn-sm " data-pro_id="{{ $x->id }}"
                                                    data-products_name="{{ $x->products_name }}" data-toggle="modal"
                    ...
                    <form action='products/update' method="post" autocomplete="off">
                        ...
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                            ...
                            <select name="category_name" id="category_name" class="custom-select my-1 mr-sm-2" required>
                                @foreach ($categories as $caticory)
                                    <option > {{ $caticory->category_name }}</option>
                                @endforeach
                            </select>
